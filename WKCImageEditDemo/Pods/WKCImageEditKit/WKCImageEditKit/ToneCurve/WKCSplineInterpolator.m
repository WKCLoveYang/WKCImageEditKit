...
@interface WKCSplineCalculator : NSObject
...
@implementation WKCSplineCalculator
{
    NSInteger _dataNum;
    double *a, *b, *c, *d;
}
...
@interface WKCSplineInterpolator()

@end

@implementation WKCSplineInterpolator
{
    NSInteger _pointNum;
    
    WKCSplineCalculator *_splineX;
    WKCSplineCalculator *_splineY;
}
...
- (id)initWithPoints:(NSArray *)points
{
    if (self = [super init])
    {
        ...
        _splineX = [[WKCSplineCalculator alloc] initWithData:dataX dataNum:_pointNum];
        _splineY = [[WKCSplineCalculator alloc] initWithData:dataY dataNum:_pointNum];

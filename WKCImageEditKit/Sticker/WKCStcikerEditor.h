...
@class WKCStcikerEditor;

@protocol WKCStcikerEditorDelegate <NSObject>
...
@interface WKCStcikerEditor : UIView

@property (nonatomic, weak) id<WKCStcikerEditorDelegate> delegate;
...
- (instancetype)initWithContentFrame:(CGRect)frame contentImage:(UIImage *)image controlSize:(CGSize)size;
